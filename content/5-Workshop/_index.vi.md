...
Trong workshop này, bạn xây dựng **AI Meeting Workforce Platform** — một nền tảng web hỗ trợ quản lý cuộc họp và công việc sau cuộc họp. Người dùng có thể đăng nhập, tạo hoặc xem phiên họp, upload transcript/audio, sau đó hệ thống dùng AI để tóm tắt nội dung, trích xuất action items và lưu các task vào dashboard theo vai trò như Admin, Manager và Employee.
...
Một số thành phần trong sơ đồ kiến trúc như VPC, ALB, EC2 Auto Scaling, NAT Gateway, VPC Endpoint, WAF hoặc SNS được trình bày như **hướng mở rộng/thiết kế production**. Khi viết báo cáo và chụp ảnh minh chứng, bạn tách rõ phần **đã triển khai trong MVP** và phần **định hướng mở rộng** để nội dung khớp với dự án thực tế.
